...
s_norm_A = 0.2;     % Company A(high resilience) Normalised std deviation
m_norm_B = 1.25;    % Company B(moderate resilience) Normalised & scaled mean
s_norm_B = 0.4;     % Company B(moderate resilience) Normalised std deviation
m_norm_C = 1.5;     % Company C(low resilience) Normalised & scaled mean
s_norm_C = 0.6;     % Company C(low resilience) Normalised std deviation
m_norm_D = 1.75;    % Company D(slightly achieved CAF) Normalised & scaled mean
s_norm_D = 0.8;     % Company D Normalised std deviation
m_norm_E = 2.0;     % Company E(mostly achieved CAF) Normalised & scaled mean
s_norm_E = 1.0;     % Company E Normalised std deviation
