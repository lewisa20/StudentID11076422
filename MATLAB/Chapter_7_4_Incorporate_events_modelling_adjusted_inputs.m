...
m_norm_C = 1.2908;    % Low Resilience Modelled Company Normalised & scaled mean
s_norm_C = 0.3883;    % Low Resilience Modelled Company Normalised std deviation
...
text(dotX(1)+0.06, dotY(1)+0.01, sprintf('Initial Access (P=%.0f%%)', dotY(1)*100), 'HorizontalAlignment','left','VerticalAlignment','middle');

plot(dotX(2), dotY(2), 'ro', 'MarkerSize', 6, 'MarkerFaceColor', 'g', 'HandleVisibility','off');
text(dotX(2)+0.06, dotY(2), sprintf('Persistance (P=%.0f%%)', dotY(2)*100), 'HorizontalAlignment','left','VerticalAlignment','middle');

plot(dotX(3), dotY(3), 'ro', 'MarkerSize', 6, 'MarkerFaceColor', 'g', 'HandleVisibility','off');
text(dotX(3)+0.06, dotY(3), sprintf('Priviledge Escalation\n(P=%.0f%%)', dotY(3)*100), 'HorizontalAlignment','left','VerticalAlignment','middle');

plot(dotX(4), dotY(4), 'ro', 'MarkerSize', 6, 'MarkerFaceColor', 'g', 'HandleVisibility','off');
text(dotX(4)+0.06, dotY(4), sprintf('Defense Evasion (P=%.0f%%)', dotY(4)*100), 'HorizontalAlignment','left','VerticalAlignment','middle');

plot(dotX(5), dotY(5), 'ro', 'MarkerSize', 6, 'MarkerFaceColor', 'g', 'HandleVisibility','off');
text(dotX(5)+0.06, dotY(5), sprintf('Lateral Movement (P=%.0f%%)', dotY(5)*100), 'HorizontalAlignment','left','VerticalAlignment','middle');

plot(dotX(6), dotY(6), 'ro', 'MarkerSize', 6, 'MarkerFaceColor', 'g', 'HandleVisibility','off');
text(dotX(6)+0.06, dotY(6), sprintf('Command & Control (P=%.0f%%)', dotY(6)*100), 'HorizontalAlignment','left','VerticalAlignment','middle');

plot(dotX(7), dotY(7), 'ro', 'MarkerSize', 6, 'MarkerFaceColor', 'g', 'HandleVisibility','off');
text(dotX(7)+0.06, dotY(7), sprintf('Inhibit Response Function (P=%.0f%%)', dotY(7)*100), 'HorizontalAlignment','left','VerticalAlignment','middle');

plot(dotX(8), dotY(8), 'ro', 'MarkerSize', 6, 'MarkerFaceColor', 'g', 'HandleVisibility','off');
text(dotX(8)+0.06, dotY(8), sprintf('Impair Process Control (P=%.0f%%)', dotY(8)*100), 'HorizontalAlignment','left','VerticalAlignment','middle');

plot(dotX(9), dotY(9), 'ro', 'MarkerSize', 6, 'MarkerFaceColor', 'g', 'HandleVisibility','off');
text(dotX(9)+0.06, dotY(9), sprintf('Critical Impact (P=%.0f%%)', dotY(9)*100), 'HorizontalAlignment','left','VerticalAlignment','middle');
...
text(dotX(1)-0.06, dotYg(1), sprintf('Initial Access (P=%.0f%%)', dotYg(1)*100), 'HorizontalAlignment','right','VerticalAlignment','middle');

plot(dotX(2), dotYg(2), 'go', 'MarkerSize', 6, 'MarkerFaceColor', 'r', 'HandleVisibility','off');
text(dotX(2)-0.06, dotYg(2), sprintf('Persistance (P=%.0f%%)', dotYg(2)*100), 'HorizontalAlignment','right','VerticalAlignment','middle');

plot(dotX(3), dotYg(3), 'go', 'MarkerSize', 6, 'MarkerFaceColor', 'r', 'HandleVisibility','off');
text(dotX(3)-0.06, dotYg(3), sprintf('Priviledge Escalation (P=%.0f%%)', dotYg(3)*100), 'HorizontalAlignment','right','VerticalAlignment','middle');

plot(dotX(4), dotYg(4), 'go', 'MarkerSize', 6, 'MarkerFaceColor', 'r', 'HandleVisibility','off');
text(dotX(4)-0.06, dotYg(4), sprintf('Defense Evasion (P=%.0f%%)', dotYg(4)*100), 'HorizontalAlignment','right','VerticalAlignment','middle');

plot(dotX(5), dotYg(5), 'go', 'MarkerSize', 6, 'MarkerFaceColor', 'r', 'HandleVisibility','off');
text(dotX(5)-0.06, dotYg(5), sprintf('Lateral Movement (P=%.0f%%)', dotYg(5)*100), 'HorizontalAlignment','right','VerticalAlignment','middle');

plot(dotX(6), dotYg(6), 'go', 'MarkerSize', 6, 'MarkerFaceColor', 'r', 'HandleVisibility','off');
text(dotX(6)-0.06, dotYg(6), sprintf('Command & Control (P=%.0f%%)', dotYg(6)*100), 'HorizontalAlignment','right','VerticalAlignment','middle');

plot(dotX(7), dotYg(7), 'go', 'MarkerSize', 6, 'MarkerFaceColor', 'r', 'HandleVisibility','off');
text(dotX(7)-0.06, dotYg(7), sprintf('Inhibit Response Function (P=%.0f%%)', dotYg(7)*100), 'HorizontalAlignment','right','VerticalAlignment','middle');

plot(dotX(8), dotYg(8), 'go', 'MarkerSize', 6, 'MarkerFaceColor', 'r', 'HandleVisibility','off');
text(dotX(8)-0.06, dotYg(8)+0.01, sprintf('Impair Process Control (P=%.0f%%)', dotYg(8)*100), 'HorizontalAlignment','right','VerticalAlignment','middle');

plot(dotX(9), dotYg(9), 'go', 'MarkerSize', 6, 'MarkerFaceColor', 'r', 'HandleVisibility','off');
text(dotX(9)-0.03, dotYg(9)+0.03, sprintf('Critical Impact (P=%.0f%%)', dotYg(9)*100), 'HorizontalAlignment','right','VerticalAlignment','middle');
...
annotation('textbox', [0.715, 0.02, 0.5, 0.3], 'String', annotation_str, ...
...
saveas(gcf, 'img_chapter_7_4_incorporate_events_adjusted.png');
